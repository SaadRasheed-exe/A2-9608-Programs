Module Module1
    ...
    Class Game
        ...
        Public Sub Play()
            ...
            Do
                ...
                If MoveDirection <> "M" Then
                    ...
                    If Not Monster.GetAwake And Not FlaskFound And Not Eaten And (Player.CheckIfSameCell(Trap1.GetPosition) And Not Trap1.GetTriggered Or Player.CheckIfSameCell(Trap2.GetPosition) And Not Trap2.GetTriggered) Then
        ...
        Public Sub DisplayTrapMessage()
            ...
            Console.WriteLine("On no! You have set off a trap. Watch out, the monster is nowawake!")
            Console.WriteLine()
    ...
    Class Grid
        ...
        Public Sub New(ByVal S As Integer, ByVal E As Integer)
            ...
            NS = S
            WE = E
            ReDim CavernState(NS, WE) 'REDIM re-creates array during the execution but losses data
        ...
        Public Sub Display(ByVal MonsterAwake As Boolean)
            ...
            For Count1 = 0 To NS
                ...
                For Count2 = 0 To WE
                    ...
                    If CavernState(Count1, Count2) = " " Or CavernState(Count1, Count2) = "*" Or (CavernState(Count1, Count2) = "M" And MonsterAwake) Then
